#!/bin/bash
# Akij Infosec Team - Zabbix 7.4 for Oracle Linux 9
RED='\033[0;31m'; GREEN='\033[0;32m'; YELLOW='\033[1;33m'; BLUE='\033[0;34m'; NC='\033[0m'
clear
echo -e "${BLUE}################################################################"
echo "#                  AKIJ INFOSEC TEAM                           #"
echo "#             ZABBIX 7.4 (ORACLE LINUX 9 SETUP)                #"
echo "################################################################${NC}"
...
rpm -Uvh https://repo.zabbix.com/zabbix/7.4/release/oracle/9/noarch/zabbix-release-latest-7.4.el9.noarch.rpm
dnf clean all
...
echo "Zabbix Pass: ${DB_PASSWORD}" > /root/zabbix_oracle_creds.txt
